            ...
            <div className='navbar-menu'>
              <ul className='nav-link-list'>
                <li className='nav-item'>
                  <a
                    href='https://github.com/jpadwor1'
                    target='_blank'
                    rel='noreferrer'
                  >
                    <img
                ...
                <li className='nav-item'>
                  <a
                    href='https://www.linkedin.com/in/johnpadworski/'
                    target='_blank'
                    rel='noreferrer'
                  >
              ...
              >
                ...
                <Box sx={{ mb: 2 }}>
                  <ul className='nav-link-list-drawer'>
                    ...
                    <li className='nav-item'>
                      <a
                        href='https://drive.google.com/uc?id=1MxdFOnG4LykUKjH47En3Xau9MFASh6xG&export=download'
                        target='_blank'
                        rel='noreferrer'
                      >
                        <img
                  ...
                  <div className='drawer-link-container'>
                    <ListItemButton onClick={toggleDrawer(false)} href='#about'>
                      <ArrowOutwardIcon
                        sx={{
                          mr: 1,
                          color: '#ffbf38',
